...
export default function PrivacyPage() {
    const [title, setTitle] = useState("นโยบายความเป็นส่วนตัว");
    ...
    useEffect(() => {
        fetch("/api/legal/privacy")
            ...
            .then(d => {
                if (d.success && d.data) {
                    setTitle(d.data.title || "นโยบายความเป็นส่วนตัว");
                    ...
                    {loading ? (
                        ...
                        <article className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
                            <div className="bg-gradient-to-br from-blue-600 to-blue-800 px-8 py-10 text-white">
                                ...
                                <p className="text-blue-100 text-sm font-medium">NaravichCare</p>
                            </div>
